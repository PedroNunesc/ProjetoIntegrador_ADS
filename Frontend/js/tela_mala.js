...
async function fetchTrips() {
  try {
    const userResponse = await fetch("https://pi-back-end-oip6.onrender.com/api/me", {
    ...
    const response = await fetch(`https://pi-back-end-oip6.onrender.com/api/trip/user/${userId}`, {
      headers: { Authorization: `Bearer ${token}` }
    });
